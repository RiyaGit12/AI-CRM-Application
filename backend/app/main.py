...
# 3. For sentiment, always use "Positive", "Negative", or "Neutral" (capitalize first letter)
...
# Example 3:
# Input: "Update sentiment to positive and add follow up: send report next week"
# Response: {{"sentiment": "Positive", "followUpActions": "send report next week"}}
...
#         print(f"edit_interaction_tool error: {e}, content: {response.content}")
#         return {}
...
# Return ONLY JSON:
# {{"aiSuggestedFollowUps": ["action 1", "action 2", "action 3"]}}
