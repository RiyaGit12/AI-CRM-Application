...
//             interactionType: d.interactionType || d.interaction_type || 'Meeting',
//             date: d.date || d.dateTime?.split('T')[0] || new Date().toISOString().split('T')[0],
//             time: d.time || d.dateTime?.split('T')[1]?.slice(0,5) || new Date().toTimeString().slice(0,5),
//             attendees: d.attendees || '',
//             topicsDiscussed: d.topicsDiscussed || d.notes || '',
//             materialsShared: d.materialsShared || [],
//             samplesDistributed: d.samplesDistributed || [],
//             sentiment: d.sentiment || d.outcome || 'Neutral',
//             outcomes: d.outcomes || d.outcome || '',
//             followUpActions: d.followUpActions || d.followUp || '',
...
//           setFormData(prev => ({
//             ...prev,
//             ...(d.hcpName !== undefined && { hcpName: d.hcpName }),
//             ...(d.hcp_name !== undefined && { hcpName: d.hcp_name }),
//             ...(d.interactionType !== undefined && { interactionType: d.interactionType }),
//             ...(d.date !== undefined && { date: d.date }),
//             ...(d.time !== undefined && { time: d.time }),
//             ...(d.attendees !== undefined && { attendees: d.attendees }),
//             ...(d.topicsDiscussed !== undefined && { topicsDiscussed: d.topicsDiscussed }),
//             ...(d.notes !== undefined && { topicsDiscussed: d.notes }),
//             ...(d.sentiment !== undefined && { sentiment: d.sentiment }),
//             ...(d.outcome !== undefined && { sentiment: d.outcome }),
//             ...(d.outcomes !== undefined && { outcomes: d.outcomes }),
//             ...(d.followUpActions !== undefined && { followUpActions: d.followUpActions }),
//             ...(d.followUp !== undefined && { followUpActions: d.followUp }),
//           }));
...
//           setFormData(prev => ({
//             ...prev,
//             topicsDiscussed: data.data.notes || prev.topicsDiscussed,
//           }));
//         } else if (data.tool === 'suggest_followup') {
//           const suggestions = data.data.suggestions || data.data.followUp || '';
//           const suggestionsArray = Array.isArray(suggestions)
//             ? suggestions
//             : suggestions.split('\n').filter(s => s.trim());
//           setFormData(prev => ({
//             ...prev,
//             aiSuggestedFollowUps: suggestionsArray
//           }));
//         }

//         setChatHistory(prev => [...prev, {
//           type: 'agent',
//           text: `Tool used: ${data.tool}`,
//           data: data.data
//         }]);
//       } else {
//         setChatHistory(prev => [...prev, { type: 'agent', text: 'Could not process request.' }]);
//       }
//     } catch (error) {
//       console.error(error);
//       setChatHistory(prev => [...prev, { type: 'agent', text: 'Server error.' }]);
//     } finally {
